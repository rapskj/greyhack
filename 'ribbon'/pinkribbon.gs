...
system_message = function(text)
	...
	print("<#c90076>[Notification]></color> This can be also launched by using 'PinkRibbon remote' or 'PinkRibbon remote [ip]'")
	print("<#c90076>[Notification]></color> 'PinkRibbon local' and 'PinkRibbon rshell'")
...
system_shell = function()
	...
	system_message("Type 'help' to see commands.")
	system_message("Alternatively you can type 'exit' to return into Targeting.")
...
system_message("You can also type 'system' in order to gain access to system commands.")
menu = function()
	...
	if target == "system" then system_shell end if
	...
	system_message("Type 'help' to see commands.")
	system_message("Alternatively you can type 'exit' to inspect another IP.")
	
	usr_shell = function()
		message = user_input("\n<color=#ff0698>Pink Ribbon > </color>")
		args = message.split(" ")
		
		
		if args[0] == "help" then
			
			print("\n<color=green>			Recon Commands.</color>\n")
			...
			print("		hack [port] -> Pink Ribbon will do the hacking for you")
			print("		routerhack [lan] -> Pink Ribbon will hack this lan address through the router")
