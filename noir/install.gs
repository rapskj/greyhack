...
title = function()
    clear_screen
    print("[Noir Installer v1.07]")
    print("Welcome to Noir Installer this will automatically compile the Noir libraries."+char(10))
end function
...
ipConf = function()
    title
    print("[Security]")
    print("You will only be able to login to Noir if you have access to the 2fa ip.")
...
fConf = function()
    ...
    globals.fname = user_input("Enter name for Noir: ")
end function
fConf
print(char(10))
comp = get_shell.host_computer
